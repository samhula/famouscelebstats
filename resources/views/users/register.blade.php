...
<body class="flex flex-col">
	...
	<main class="h-screen flex flex-col p-5 gap-4 w-full md:w-11/12 xl:w-9/12 mx-auto">
		<form method="POST" action="{{config('global.constants.URL')}}/users" enctype="multipart/form-data" class="space-y-4">
			@csrf
				<div class="flex flex-col">
					<label class="font-semibold uppercase text-sm" for="name">Name</label>
					<input type="text" name="name" id="name" value="{{old('name')}}" class="border outline-none rounded resize-none p-2 focus:ring focus:ring-cyan-600 bg-gray-200 focus:bg-white placeholder:italic">
				...
				<div class="flex flex-col">
					<label class="font-semibold uppercase text-sm" for="password_confirmation">Password Confirmation</label>
					<input type="password" name="password_confirmation" id="password_confirmation" class="border outline-none rounded resize-none p-2 focus:ring focus:ring-indigo-700 bg-gray-200 focus:bg-white placeholder:italic">
